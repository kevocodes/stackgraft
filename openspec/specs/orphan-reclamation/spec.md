...
Ownership proof, the label set, and the sidecar are specified in `../overlay-ownership/spec.md`; this capability consumes them and never re-derives them. Store copies are created by `../isolation-providers/spec.md` and carry the label set specified in `../overlay-ownership/spec.md`.
